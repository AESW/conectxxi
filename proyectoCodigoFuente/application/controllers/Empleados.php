...
class Empleados extends CI_Controller {
    ...
    public function index()
    {
    	...
    	$dataScoring["amai_escolaridad_jefe_familia"] = array("scoring" => 0 , "respuesta" => "Sin instrucci�n" );
    	...
    	if( $Focos == "5menos" ):
    	$dataScoring["amai_no_focos"] = array("scoring" => 0 , "respuesta" => "Sin instrucci�n" );
    	elseif( $Focos == "6-10" ):
    	...
    	$ci->email->to ( $to );
    	$ci->email->subject ( 'Confirmaci�n de datos personales para candidatos.' );
    	$ci->email->message ('
  ...
  <tr>
    <td style="background-color: #fff; padding-top:25px; padding-bottom:135px; padding-left:10px; padding-right:10px; font-family: Arial;color: #7F7F7F; font-size:15px;"><center>
     <p style="font-weight:bold;color:#26313c;">Apreciable '.$resultado["nombre_candidato"].' '.$resultado["apellido_paterno_candidato"].' '.$resultado["apellido_materno_candidato"].',</p>
        ...
        <p>Confirmar tu cuenta de correo <a href="'.HOME_URL.'Empleados/verificar/?token='.$hashValidacion.'" target="_blank">dando clic aqu�</a></p>
    </center>
    </td>
    </tr>
    </table>
