	...
	?>
     ...
     <?php
	                                                ...
	                                                ?>
	                                                 ...
	                                                 <?php 
  	                                         if( !empty($PlanDetalleHistoria) ):    
	                                                    foreach($PlanDetalleHistoria as  $t){ 


$portafolio=$t->agr_cliente;


$idportafolio=$t->idportafolio;
...
?>    
    ...
    <thead>
    	...
    	<tr>
                                     ...
                                     <option value="<?php echo $idportafolio?>" /><?php echo $portafolio ?>                  
                            <?php 
    ...
    <thead>
    	...
    	<tr>
														<th colspan="2">Mejor Mes <a id="mejor" name="mejor" href="<?php echo HOME_URL; ?>index.php/PlanMaestro/consultaHistoria/<?php echo $portafolio; ?>"  class="btn btn-success">Consultar</a></th>
														<th colspan="2">Promedio <a href="#" class="btn btn-success">Consultar</a></th>
														<th colspan="2">Peor Mes <a id="peor" name="peor" href="<?php echo HOME_URL; ?>index.php/PlanMaestro/HistoriaBaja/<?php echo $portafolio; ?>"   class="btn btn-success">Consultar</a></th>
...
$Addproducto = trim($t->agr_producto);
$frm = str_replace(" ", "", $Addproducto);



$acciones=  $t->gestiones/$t->cuentas;

$tiempo=  $t->tiempo_llamada*60/$t->gestiones*60;

$pronostico=$acciones*$t->cuentas;

$horas=$tiempo*$pronostico/60;

$personas=$horas/(26*7);

$total=$personas*14000.00;

/////

$alcanceCarteo=  ($t->carteo/$t->cuentas)*100;

$cartas=($t->cuentas*$alcanceCarteo*1)/100;

$cartotal=$cartas*3.00;
...
$alcanceVisitas=  ($t->visitas/$t->cuentas)*100;


$visitas=($t->cuentas*$alcanceVisitas*1)/100;

$vistotal=$visitas*30.31;
...
$alcanceSms=  ($t->sms/$t->cuentas)*100;


$sms=($t->cuentas*$alcanceSms*1)/100;
...
$alcanceFijo=  ($t->robot_fijo/($t->robot_fijo+$t->robot_movil))*100;
$alcanceMovil=  100-$alcanceFijo;
...
$tfijo=($pronostico*$tiempo*$alcanceFijo)/100;

$tmovil=($pronostico*$tiempo*$alcanceMovil)/100;

$costofijo=$tfijo*.07;

$costomovil=$tmovil*.40;



////////

$costototal=$total+$cartotal+$vistotal+$teltotal+$smstotal+$costofijo+$costomovil;
...
$total=$costototal;
$facturacion=$t->importe;


if($facturacion>0){

$utilidad=(1-($total/$facturacion))*100;
...
?>    
     ...
     <td id="<?php echo $frm ?>" width=170> <select class="productopersonal form-control" id="productopersonal" name="productopersonal">
                   <option value="<?php echo $t->agr_producto?>" /><?php echo $t->agr_producto?>                 
                           
              </select></td>
 
    <td> <input type="text" class="asigcuentas form-control"   name="asigcuentas[]" value="<?php echo number_format($t->cuentas)?>"/></td>
    <td> <input type="text" class="asigsaldo form-control"   name="asigsaldo[]" value="<?php echo number_format($t->saldo,2) ?>"/></td>
    <td> <input type="text" class="asigfacturacion form-control"   name="asigfacturacion[]" value="<?php echo number_format($facturacion,2)?>"/></td>
    
    <td> <input type="text" class="asigcosto form-control" readonly  name="asigcosto" value="<?php echo number_format($total,2) ?>"/></td>
    <td> <input type="text" class="asigutilidad form-control"  readonly name="asigutilidad" value="<?php echo number_format($utilidad,2) ?>"/></td>
...
$frm = str_replace(" ", "", $Addproducto);
   ...
   <td id="<?php echo $frm ?>" width=170><input type="text" class="productouno form-control" readonly  id="productouno" name="productouno" value="<?php echo $t->agr_producto?>"/></td>
    <td> <input type="text" class="cpacciones form-control"  name="cpacciones[]" value="<?php echo number_format($acciones,2) ?>"/></td>
    <td> <input type="text" class="cpcuentas form-control" readonly name="cpcuentas" value="<?php echo number_format($t->cuentas)?>"/></td>
    <td> <input type="text" class="cptiempo form-control"  name="cptiempo[]" value="<?php echo number_format($tiempo,2) ?>"/></td>
    <td> <input type="text" class="cppronostico form-control"  readonly  name="cppronostico" value="<?php echo number_format($pronostico,2) ?>"/></td>
    <td> <input type="text" class="cphoras form-control" readonly  name="cphoras" value="<?php echo number_format($horas,2) ?>"/></td>
    <td> <input type="text" class="cpturnos form-control" id="cpturnos" name="cpturnos[]" value="2"/></td>
    <td> <input type="text" class="cppersonas form-control" readonly  name="cppersonas" value="<?php echo number_format($personas,2) ?>"/></td>
    <td> <input type="text" class="cpcosto form-control"  readonly name="cpcosto" value="14,000.00"/></td>
    <td> <input type="text" class="cptotal form-control" readonly  name="cptotal" value="<?php echo number_format($total,2) ?>"/></td>
...
$frm = str_replace(" ", "", $Addproducto);
    ...
    <td id="<?php echo $frm ?>" width=170><input type="text" class="productodos form-control" readonly  id="productodos" name="productodos" value="<?php echo $t->agr_producto?>"/></td>
     <td><input type="text" class="caralcance form-control"  name="caralcance[]" value="<?php echo number_format($alcanceCarteo,2) ?>"/></td>  
    <td><input type="text" class="carintensidad form-control"  name="carintensidad[]" value="1"/></td>
    <td><input type="text" class="carcartas form-control" readonly name="carcartas" value="<?php echo number_format($cartas,2) ?>"/></td>
    <td><input type="text" class="carcostos form-control" readonly  name="carcostos" value="3.00"/></td>
    <td><input type="text" class="cartotal form-control" readonly  name="cartotal" value="<?php echo number_format($cartotal,2) ?>"/></td>
    </tr>
...
$frm = str_replace(" ", "", $Addproducto);
                                    ...
                                    <tr class="odd gradeX">
    <td id="<?php echo $frm ?>"><input type="text" class="visalcance form-control"  name="visalcance[]" value="<?php echo number_format($alcanceVisitas,2) ?>"/></td>  
    <td><input type="text" class="visintensidad form-control"  name="visintensidad[]" value="1" /></td>
    <td><input type="text" class="visvolumen form-control" readonly name="visvolumen" value="<?php echo number_format($visitas,2) ?>" /></td>
    <td><input type="text" class="viscosto form-control" readonly name="viscosto" value="30.31" /></td>
    <td><input type="text" class="vistotal form-control" readonly  name="vistotal" value="<?php echo number_format($vistotal,2) ?>" /></td>
   </tr>
...
?>           
                                    <tr class="odd gradeX">
                                   <td id="<?php echo $frm ?>" width=170><input type="text" class="productotres form-control" readonly  id="productotres" name="productotres" value="<?php echo $t->agr_producto?>"/></td>
 
    <td> <input type="text" class="teltiempo form-control" readonly  name="teltiempo" value="<?php echo number_format($taire,2) ?>" /></td>
    <td> <input type="text" class="telcosto form-control" readonly name="telcosto" value="0.07" /></td>
    <td> <input type="text" class="teltotal form-control" readonly  name="teltotal" value="<?php echo number_format($teltotal,2) ?>" /></td>
...
$frm = str_replace(" ", "", $Addproducto);
	                                                    	...
	                                                    	?>                 
                                    <tr class="odd gradeX">
    <td id="<?php echo $frm ?>"><input type="text" class="smsalcance form-control"  name="smsalcance[]" value="<?php echo number_format($alcanceSms,2) ?>"/></td>  
    <td><input type="text" class="smsintensidad form-control"  name="smsintensidad[]" value="1"/></td>
    <td><input type="text" class="smsvolumen form-control" readonly name="smsvolumen" value="<?php echo number_format($sms,2) ?>"/></td>
    <td><input type="text" class="smscosto form-control" readonly name="smscosto" value="0.30"/></td>
    <td><input type="text" class="smstotal form-control" readonly  name="smstotal" value="<?php echo number_format($smstotal,2) ?>"/></td>
   </tr>
    ...
    <thead>
    	...
    	<tr><th headers="tiempo" rowspan="2">Producto</th>
													...
													<th headers="tiempo" colspan="4">A Fijo</th>
													
													<th headers="tiempo" colspan="4">A móvil</th>
...
$frm = str_replace(" ", "", $Addproducto);
     ...
     <td id="<?php echo $frm ?>" width=170><input type="text" class="productocuatro form-control" readonly  id="productocuatro" name="productocuatro" value="<?php echo $t->agr_producto?>"/></td>
    <td> <input type="text" class="tottiempo form-control" readonly  name="tottiempo" value="<?php echo number_format($tfijo,2)?>"/></td>
    <td><input type="text" class="porfijo form-control"   name="porfijo[]" value="<?php echo number_format($alcanceFijo,2) ?>"/></td>
    <td> <input type="text" class="totcosto form-control" readonly  name="totcosto" value="0.07"/></td>
    <td> <input type="text" class="tottotal form-control" readonly  name="tottotal" value="<?php echo number_format($costofijo,2) ?>"/></td>
    <td> <input type="text" class="tottiempomovil form-control" readonly  name="tottiempomovil" value="<?php echo number_format($tmovil,2) ?>"/></td>
    <td><input type="text" class="pormovil form-control"   name="pormovil[]" value="<?php echo number_format($alcanceMovil,2)?>"/></td>
    <td> <input type="text" class="totcostomovil form-control" readonly  name="totcostomovil" value="0.40"/></td>
    <td> <input type="text" class="tottotalmovil form-control" readonly  name="tottotalmovil" value="<?php echo number_format($costomovil,2) ?>"/></td>
   </tr>
...
$costototal=$total+$cartotal+$vistotal+$teltotal+$smstotal+$costofijo+$costomovil;
 ...
 ?>                 
    ...
    <td id="<?php echo $frm ?>"> <input type="text" class="productocinco form-control"  readonly   id="productocinco" name="productocinco" value="<?php echo $t->agr_producto?>"/></td>
    <td> <input type="text" class="totcostoFinal form-control" readonly name="totcostoFinal" value="<?php echo number_format($costototal,2) ?>"/></td>
...
$ausentismo=$personas*0.1;

$totpersonas=$personas+$ausentismo;

$variacion=$totpersonas-$t->gestores;
...
?>               
    ...
    <td id="<?php echo $frm ?>" width=170 ><input type="text" class="productoseis form-control" readonly   id="productoseis" name="productoseis" value="<?php echo $t->agr_producto?>"/></td>
    <td ><input type="text" class="cthoras form-control" readonly  name="cthoras" value="<?php echo number_format($horas,2) ?>" /> </td>
   <td><input type="text" class="ctpersonas form-control" readonly name="ctpersonas" value="<?php echo number_format($personas,2) ?>" /></td>
    <td> <input type="text" class="ctausentismo form-control" readonly  name="ctausentismo" value="<?php echo number_format($ausentismo,2) ?>" /></td>
   <td> <input type="text" class="cttotal form-control" readonly  name="cttotal" value="<?php echo number_format($totpersonas,2) ?>" /></td>
   <td> <input type="text" class="ctplantilla form-control"   name="ctplantilla[]" value="<?php echo number_format($t->gestores,2) ?>" /></td>
   <td> <input type="text" class="ctvariacion form-control" readonly  name="ctvariacion" value="<?php echo number_format($variacion,2) ?>" /></td>
        ...
        <?php 
                       ...
                       <div class="form-group">
							...
							<textarea cols="95" rows="5"  maxlength="250" id="AccionesRealizar" name="AccionesRealizar" class="vf_otf" ></textarea>  
...
/////////////////////////////////////////////////////
    ...
    /////////////////////////////////////////////////////
        ...
        $.ajax({
            url: '<?php echo HOME_URL; ?>index.php/PlanMaestro/AddPlan',
            type: 'POST',
            dataType: 'json',
            data: formData,
            cache: false,
            ...
            success: function(response) {
                if (response.codigo != 200) {
                    ...
                    alertify.success(response.mensaje, "success", 1500);
                    setTimeout(function() {
                    	 document.location.href = "<?php echo HOME_URL; ?>index.php/PlanMaestro/";
                    }, 1500);
                }
            },
...
function number_format(number, decimals, dec_point, thousands_sep) {
   ...
   <script type="text/javascript">
          ...
          $( "#CalcularBtn" ).click(function() {
              ...
              for (var i = 0; i <asigcuentas.length; i++) {
                  ...
                  var lporfijo=valorporfijo[i];
                  var lpormovil=valorpormovil[i];
                 ...
                 var lcartasvolumen=(lcaralcance.value.replace(",","")*lcarintensidad.value.replace(",","")*cuentas.value.replace(",",""))/100;
                  ...
                  document.getElementsByName("cpcuentas")[i].value = number_format(cuentas.value, 2);
 ...
 $('#agregarProducto').click(function(event) {
    ...
    campoTelefonia="<tr class='odd gradeX'><td id='"+frm+"' width=170><input type='text' class='form-control' readonly   name='productotelefonia' value='"+Addproducto+"' /></td><td> <input type='text' class='teltiempo form-control' readonly  name='teltiempo'/></td><td> <input type='text' class='telcosto form-control' readonly name='telcosto'/></td><td> <input type='text' class='teltotal form-control' readonly  name='teltotal'/></td></tr>";
    	campoCarteo="<tr class='odd gradeX'><td id='"+frm+"' width=170><input type='text' class='productodos form-control' readonly   name='productodos' value='"+Addproducto+"'/></td><td><input type='text' class='caralcance form-control'  name='caralcance[]'/></td>  <td><input type='text' class='carintensidad form-control'  name='carintensidad[]'/></td><td><input type='text' class='carcartas form-control' readonly name='carcartas'/></td><td><input type='text' class='carcostos form-control' readonly  name='carcostos'/></td><td><input type='text' class='cartotal form-control' readonly  name='cartotal'/></td></tr>";
    		...
    		campoBlaster="<tr class='odd gradeX'><td id='"+frm+"' width=170><input type='text' class='pruductocuatro form-control' readonly  name='pruductocuatro' value='"+Addproducto+"' /></td><td> <input type='text' class='tottiempo form-control' readonly  name='tottiempo'/></td><td><input type='text' class='porfijo form-control'   name='porfijo[]' /></td><td> <input type='text' class='totcosto form-control' readonly  name='totcosto'/></td><td> <input type='text' class='tottotal form-control' readonly  name='tottotal'/></td><td> <input type='text' class='tottiempomovil form-control' readonly  name='tottiempomovil'/></td><td><input type='text' class='pormovil form-control'   name='pormovil[]' /></td><td> <input type='text' class='totcostomovil form-control' readonly  name='totcostomovil'/></td><td> <input type='text' class='tottotalmovil form-control' readonly  name='tottotalmovil'/></td></tr>";
