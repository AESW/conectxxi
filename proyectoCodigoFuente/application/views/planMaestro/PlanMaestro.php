...
?>
   ...
   <?php
    ...
    <thead>
    	...
    	<tr>
														<th colspan="2">Mejor Mes <a id="mejor" name="mejor"   class="btn btn-success">Consultar</a></th>
														<th colspan="2">Promedio <a href="#" class="btn btn-success">Consultar</a></th>
														<th colspan="2">Peor Mes <a id="peor" name="peor"    class="btn btn-success">Consultar</a></th>
    ...
    <tbody>
     ...
     <td width=170> <select class="productopersonal form-control" id="productopersonal" name="productopersonal">
                    <option value="" />Seleccione...                    
                           
              </select></td>
 
    <td> <input type="text" class="asigcuentas form-control"   name="asigcuentas[]"/></td>
    <td> <input type="text" class="asigsaldo form-control"   name="asigsaldo[]"/></td>
    <td> <input type="text" class="asigfacturacion form-control"   name="asigfacturacion[]"/></td>
    
    <td> <input type="text" class="asigcosto form-control" readonly  name="asigcosto"/></td>
    <td> <input type="text" class="asigutilidad form-control"  readonly name="asigutilidad"/></td>
   ...
   <td width=170><input type="text" class="productouno form-control" readonly  id="productouno" name="productouno"/></td>
    <td> <input type="text" class="cpacciones form-control"  name="cpacciones[]"/></td>
    <td> <input type="text" class="cpcuentas form-control" readonly name="cpcuentas"/></td>
    <td> <input type="text" class="cptiempo form-control"  name="cptiempo[]"/></td>
    <td> <input type="text" class="cppronostico form-control"  readonly  name="cppronostico"/></td>
    <td> <input type="text" class="cphoras form-control" readonly  name="cphoras"/></td>
    <td> <input type="text" class="cpturnos form-control" id="cpturnos" name="cpturnos[]"/></td>
    <td> <input type="text" class="cppersonas form-control" readonly  name="cppersonas"/></td>
    <td> <input type="text" class="cpcosto form-control"  readonly name="cpcosto"/></td>
    <td> <input type="text" class="cptotal form-control" readonly  name="cptotal"/></td>
    ...
    <td width=170><input type="text" class="productodos form-control" readonly  id="productodos" name="productodos"/></td>
     <td><input type="text" class="caralcance form-control"  name="caralcance[]"/></td>  
    <td><input type="text" class="carintensidad form-control"  name="carintensidad[]"/></td>
    <td><input type="text" class="carcartas form-control" readonly name="carcartas"/></td>
    <td><input type="text" class="carcostos form-control" readonly  name="carcostos"/></td>
    <td><input type="text" class="cartotal form-control" readonly  name="cartotal"/></td>
    </tr>
    </tbody>
    </table>
    ...
    <tbody>
                                    ...
                                    <tr class="odd gradeX">
    <td><input type="text" class="visalcance form-control"  name="visalcance[]"/></td>  
    <td><input type="text" class="visintensidad form-control"  name="visintensidad[]"/></td>
    <td><input type="text" class="visvolumen form-control" readonly name="visvolumen" /></td>
    <td><input type="text" class="viscosto form-control" readonly name="viscosto" /></td>
    <td><input type="text" class="vistotal form-control" readonly  name="vistotal" /></td>
   </tr>
    </tbody>
    </table>
    ...
    <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                   <td width=170><input type="text" class="productotres form-control" readonly  id="productotres" name="productotres"/></td>
 
    <td> <input type="text" class="teltiempo form-control" readonly  name="teltiempo"/></td>
    <td> <input type="text" class="telcosto form-control" readonly name="telcosto"/></td>
    <td> <input type="text" class="teltotal form-control" readonly  name="teltotal"/></td>
    ...
    <tbody>
                                    ...
                                    <tr class="odd gradeX">
    <td><input type="text" class="smsalcance form-control"  name="smsalcance[]"/></td>  
    <td><input type="text" class="smsintensidad form-control"  name="smsintensidad[]"/></td>
    <td><input type="text" class="smsvolumen form-control" readonly name="smsvolumen"/></td>
    <td><input type="text" class="smscosto form-control" readonly name="smscosto"/></td>
    <td><input type="text" class="smstotal form-control" readonly  name="smstotal"/></td>
   </tr>
    </tbody>
    </table>
    ...
    <thead>
    	...
    	<tr><th headers="tiempo" rowspan="2">Producto</th>
													...
													<th headers="tiempo"><input type="text" class="porfijo form-control"   name="porfijo[]"/></th>
													<th headers="tiempo" colspan="2">A móvil</th>
													<th headers="tiempo"><input type="text" class="pormovil form-control"   name="pormovil[]"/></th>
    ...
    <tbody>
     ...
     <td width=170><input type="text" class="productocuatro form-control" readonly  id="productocuatro" name="productocuatro"/></td>
    <td> <input type="text" class="tottiempo form-control" readonly  name="tottiempo"/></td>
    <td> <input type="text" class="totcosto form-control" readonly  name="totcosto"/></td>
    <td> <input type="text" class="tottotal form-control" readonly  name="tottotal"/></td>
    <td> <input type="text" class="tottiempomovil form-control" readonly  name="tottiempomovil"/></td>
    <td> <input type="text" class="totcostomovil form-control" readonly  name="totcostomovil"/></td>
    <td> <input type="text" class="tottotalmovil form-control" readonly  name="tottotalmovil"/></td>
   </tr>
    ...
    <td> <input type="text" class="productocinco form-control"  readonly   id="productocinco" name="productocinco"/></td>
    <td> <input type="text" class="totcostoFinal form-control" readonly name="totcostoFinal"/></td>
    ...
    <td width=170 ><input type="text" class="productoseis form-control" readonly   id="productoseis" name="productoseis"/></td>
    <td ><input type="text" class="cthoras form-control" readonly  name="cthoras"/> </td>
   <td><input type="text" class="ctpersonas form-control" readonly name="ctpersonas"/></td>
    <td> <input type="text" class="ctausentismo form-control" readonly  name="ctausentismo"/></td>
   <td> <input type="text" class="cttotal form-control" readonly  name="cttotal"/></td>
   <td> <input type="text" class="ctplantilla form-control"   name="ctplantilla[]"/></td>
   <td> <input type="text" class="ctvariacion form-control" readonly  name="ctvariacion"/></td>
...
function number_format(number, decimals, dec_point, thousands_sep) {
   ...
   <script type="text/javascript">
          ...
          $( "#CalcularBtn" ).click(function() {
              ...
              for (var i = 0; i <asigcuentas.length; i++) {
                  ...
                  var lpronostico=cuentas.value*acciones.value;
                  var lhoras=(tiempo.value*lpronostico)/60;
                  var lpersonas=lhoras/(ldiaslab*7);
                  var ltotal=lpersonas*costo;

                  var lteltiempo=(tiempo.value*lpronostico);

               
                  var lteltotal= lteltiempo*ltelcosto;

                  var lcartasvolumen=(lcaralcance.value*lcarintensidad.value*cuentas.value)/100;
                  var lcartotal=lcartasvolumen*valorcarcosto;

                  var lvisitasvolumen=(lvisalcance.value*lvisintensidad.value*cuentas.value)/100;
                  var lvistotal=lvisitasvolumen*valorviscosto;

                  var lsmsvolumen=(lsmsalcance.value*lsmsintensidad.value*cuentas.value)/100;
                  var lsmstotal=lsmsvolumen*valorsmscosto;

                  var lfijoaire=(lteltiempo*lporfijo.value)/100;
                  var lmovilaire=(lteltiempo*lpormovil.value)/100;
                  ...
                  var lfactot=(1-(lctctotal/lfacturacion.value))*100;
 ...
 $('#agregarProducto').click(function(event) {
    ...
    campoAsignacion="<tr class='odd gradeX'><td id='"+frm.trim()+"' width=170><input type='text' class='productopersonal form-control' readonly  name='productopersonal'  value='"+Addproducto+"' /></td><td> <input type='text' class='asigcuentas form-control'   name='asigcuentas[]'/></td><td> <input type='text' class='asigsaldo form-control'   name='asigsaldo[]'/></td><td> <input type='text' class='asigfacturacion form-control'   name='asigfacturacion[]'/></td><td> <input type='text' class='asigcosto form-control' readonly  name='asigcosto'/></td><td> <input type='text' class='asigutilidad form-control'  readonly name='asigutilidad'/></td></tr>";
    campoPersonal="<tr class='odd gradeX'><td id='"+frm.trim()+"' width=170><input type='text' class='productouno form-control' readonly  name='productouno'  value='"+Addproducto+"' /></td><td> <input type='text' class='cpacciones form-control'  name='cpacciones[]'/></td><td> <input type='text' class='cpcuentas form-control' readonly name='cpcuentas'/></td><td> <input type='text' class='cptiempo form-control'  name='cptiempo[]'/></td><td> <input type='text' class='cppronostico form-control'  readonly  name='cppronostico'/></td><td> <input type='text' class='cphoras form-control' readonly  name='cphoras'/></td><td> <input type='text' class='cpturnos form-control' id='cpturnos' name='cpturnos[]'/></td><td> <input type='text' class='cppersonas form-control' readonly  name='cppersonas'/></td><td> <input type='text' class='cpcosto form-control'  readonly name='cpcosto'/></td><td> <input type='text' class='cptotal form-control' readonly  name='cptotal'/></td></tr>";
    campoTelefonia="<tr class='odd gradeX'><td id='"+frm.trim()+"' width=170><input type='text' class='form-control' readonly   name='productotelefonia' value='"+Addproducto+"' /></td><td> <input type='text' class='teltiempo form-control' readonly  name='teltiempo'/></td><td> <input type='text' class='telcosto form-control' readonly name='telcosto'/></td><td> <input type='text' class='teltotal form-control' readonly  name='teltotal'/></td></tr>";
    	campoCarteo="<tr class='odd gradeX'><td id='"+frm.trim()+"' width=170><input type='text' class='productodos form-control' readonly   name='productodos' value='"+Addproducto+"'/></td><td><input type='text' class='caralcance form-control'  name='caralcance[]'/></td>  <td><input type='text' class='carintensidad form-control'  name='carintensidad[]'/></td><td><input type='text' class='carcartas form-control' readonly name='carcartas'/></td><td><input type='text' class='carcostos form-control' readonly  name='carcostos'/></td><td><input type='text' class='cartotal form-control' readonly  name='cartotal'/></td></tr>";
    		campoSms="<tr class='odd gradeX'><td id='"+frm.trim()+"'><input type='text' class='smsalcance form-control'  name='smsalcance[]'/></td>  <td><input type='text' class='smsintensidad form-control'  name='smsintensidad[]'/></td><td><input type='text' class='smsvolumen form-control' readonly name='smsvolumen'/></td><td><input type='text' class='smscosto form-control' readonly name='smscosto'/></td><td><input type='text' class='smstotal form-control' readonly  name='smstotal'/></td></tr>";
    		campoBlaster="<tr class='odd gradeX'><td id='"+frm.trim()+"' width=170><input type='text' class='pruductocuatro form-control' readonly  name='pruductocuatro' value='"+Addproducto+"' /></td><td> <input type='text' class='tottiempo form-control' readonly  name='tottiempo'/></td><td> <input type='text' class='totcosto form-control' readonly  name='totcosto'/></td><td> <input type='text' class='tottotal form-control' readonly  name='tottotal'/></td><td> <input type='text' class='tottiempomovil form-control' readonly  name='tottiempomovil'/></td><td> <input type='text' class='totcostomovil form-control' readonly  name='totcostomovil'/></td><td> <input type='text' class='tottotalmovil form-control' readonly  name='tottotalmovil'/></td></tr>";
    				campoVisitas="<tr class='odd gradeX'><td id='"+frm.trim()+"'><input type='text' class='visalcance form-control'  name='visalcance[]'/></td><td><input type='text' class='visintensidad form-control'  name='visintensidad[]'/></td><td><input type='text' class='visvolumen form-control' readonly name='visvolumen' /></td><td><input type='text' class='viscosto form-control' readonly name='viscosto' /></td><td><input type='text' class='vistotal form-control' readonly  name='vistotal' /></td></tr>";
    				campoTotCostos="<tr class='odd gradeX'><td id='"+frm.trim()+"'><input type='text' class='form-control'  readonly    name='productoTotal' value='"+Addproducto+"'/></td><td><input type='text' class='totcostoFinal form-control' readonly name='totcostoFinal'/></td></tr>";
    				campoTotal="<tr class='odd gradeX'><td id='"+frm.trim()+"' width=170><input type='text' class='productocinco form-control' readonly   name='productocinco' value='"+Addproducto+"'/></td><td ><input type='text' class='cthoras form-control' readonly  name='cthoras'/> </td><td><input type='text' class='ctpersonas form-control' readonly name='ctpersonas'/></td><td><input type='text' class='ctausentismo form-control' readonly  name='ctausentismo'/></td><td><input type='text' class='cttotal form-control' readonly  name='cttotal'/></td><td><input type='text' class='ctplantilla form-control'   name='ctplantilla[]'/></td><td><input type='text' class='ctvariacion form-control' readonly  name='ctvariacion'/></td></tr>";
