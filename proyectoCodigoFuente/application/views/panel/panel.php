<div class="panel_eaf">
	<div class="block_1_eaf">
		<a href="<?php echo HOME_URL."Panel/Inicio/"; ?>" class="eaf_reclutamiento_option"></a>
	<!-- 	<a href="<?php echo HOME_URL."eaf/RecursosHumanos/"; ?>" class="eaf_recursos_humanos"></a>-->
		<a href="#" class="eaf_capacitacion_option"></a>
		<a href="<?php echo HOME_URL."MovEmpleados/ConsultaCapacitacion"; ?>" class="eaf_capacitacion_option" ></a>
		<a href="<?php echo HOME_URL."MovEmpleados/ConsultaDescuentos"; ?>" class="eaf_descuentos_option"></a>
		<a href="<?php echo HOME_URL."Panel/Jerarquia/"; ?>" class="eaf_altas_option"></a> 
		<a href="<?php echo HOME_URL."MovEmpleados/ConsultaAsistencia"; ?>" class="eaf_asistencia_option"></a>
	...
	<div class="block_2_eaf">
		<a href="<?php echo HOME_URL."MovEmpleados/ConsultaBonos"; ?>" class="eaf_bonos_option"></a>
		<a href="<?php echo HOME_URL."MovEmpleados/"; ?>" class="eaf_movimientos_option"></a>
