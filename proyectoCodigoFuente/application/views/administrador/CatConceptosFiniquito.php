				       ...
				       <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                 ...
                                 <?php 
	                                                ...
	                                                if( !empty($ConceptosFiniquito) ):    
	                                                    foreach($ConceptosFiniquito as  $v){ ?>
                                
                                    <tr class="odd gradeX">
                                        <td><?php echo $v->idConcepto?></td>
                                        <td><?php echo $v->Concepto?></td>
                                          <td><?php echo $v->tipo?></td>
                                               <td class="center">
                                           <center>
                                     
                                             <a data-toggle="modal" href="#ModalBaja" data-id="<?php echo $v->idConcepto?>"  data-valor="<?php echo $v->Concepto?>" data-parametro="<?php echo $v->tipo?>" data-estatus="<?php echo $v->estatus?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-floppy-remove"></i></a>
                                           ...
                                           <center>
                                             ...
                                             <a data-toggle="modal" href="#ModalEdita"   data-id="<?php echo $v->idConcepto?>" data-valor="<?php echo $v->Concepto?>" data-parametro="<?php echo $v->tipo?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-pencil"></i></a>
...
<br>
 ...
 <form class="form-horizontal" id="formitemEditar" action="<?php echo HOME_URL; ?>index.php/PlanMaestro/"  />
														...
														<div class="form-group">
																<label class="col-sm-3 control-label">PARAMETRO:</label>
																<div class="col-sm-6">
																<select id="editaParametro" style="width:100%;"   name="editaParametro" >
