...
if(estatus=='inactivo')
{
	$(".modal-body #Estatus").val( 'activo' );
}
else
{

	$(".modal-body #Estatus").val( 'inactivo' );
}
...
<a data-toggle="modal" href="#ModalPuestoActual"   class="btn btn-success"> <i class="glyphicon glyphicon-plus"></i>
						        <span>Nuevo Departamento</span></a>
				       ...
				       <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                 ...
                                 <?php 
                                    ...
                                    <tr class="odd gradeX">
                                        <td><?php echo $v->idDepartamentos?></td>
                                        <td><?php echo $v->nombreDepartamento?></td>
                                         <td><?php echo $v->nombreEmpresas?></td>
                                           ...
                                           <center>
                                             ...
                                             <a data-toggle="modal" href="#ModalBaja" data-id="<?php echo $v->idDepartamentos?>"  data-valor="<?php echo $v->nombreDepartamento?>" data-parametro="<?php echo $v->idEmpresas?>" data-estatus="<?php echo $v->estatusDepartamento?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-floppy-remove"></i></a>
                                           ...
                                           <center>
                                             ...
                                             <a data-toggle="modal" href="#ModalEdita"   data-id="<?php echo $v->idDepartamentos?>" data-valor="<?php echo $v->nombreDepartamento?>"  data-parametro="<?php echo $v->idEmpresas?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-pencil"></i></a>
 ...
 <form class="form-horizontal" id="formitemEditar" name="formitemEditar" action="<?php echo HOME_URL; ?>index.php/PlanMaestro/"  />
															...
															<div class="form-group">
																<label class="col-sm-3 control-label">EMPRESA:</label>
																<div class="col-sm-6">
																	<select id="Editempresa" style="width:100%" name="Editempresa" >
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal"
																aria-hidden="true">&times;</button>
															<h4 class="modal-title">ACTIVAR/DESACTIVAR DEPARTAMENTO</h4>
														</div>
														<div class="modal-body">
 <form class="form-horizontal" id="formitemElimina" action="<?php echo HOME_URL; ?>Administrador/Catalogos/"  />
															...
															<div class="form-group">
																<label class="col-sm-3 control-label">EMPRESA:</label>
																<div class="col-sm-6">
																	<select id="Bajaempresa" style="width:100%" name="Bajaempresa" >
	...
	<script src="<?php echo HOME_URL; ?>assets/js/jquery.fileupload.js"></script>
                                    ...
                                    $('#agregarProducto').click(function(event) {
                                        ...
                                        if ($('#formitem').valid()) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/AddDepartamento',
                                                type: 'POST',
                                                dataType: 'json',
					 ...
					 <script type="text/javascript">
                                    ...
                                    $('#eliminarProducto').click(function(event) {
                                        event.preventDefault();
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/EstatusCatalogoDepartamento',
                                                type: 'POST',
                                                dataType: 'json',
                                    ...
                                    $('#editarProducto').click(function(event) {
                                        ...
                                        if ($('#formitemEditar').valid()) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/ActualizaCatalogoDepartamento',
                                                type: 'POST',
                                                dataType: 'json',
