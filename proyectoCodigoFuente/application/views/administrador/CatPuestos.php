...
$(".modal-body #editEmpresa").val( parametro );
$(".modal-body #BajaEmpresa").val( parametro );
				       ...
				       <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                 ...
                                 <?php 
                                    ...
                                    <tr class="odd gradeX">
                                        <td><?php echo $v->idPuestos?></td>
                                        <td><?php echo $v->nombrePuesto?></td>
                                     ...
                                     $resultado = str_replace(" ", "", $v->nombrePuesto);
                                     
                                     ?>
                                     
                                             <a target="_blank" href="<?php echo HOME_URL;?>PerfilesDoc/<?php echo $resultado?>.pdf"  class="btn btn-success "><i class="glyphicon glyphicon-file"></i></a>
                                           ...
                                           <center>
                                             ...
                                             <a data-toggle="modal" href="#ModalBaja" data-id="<?php echo $v->idPuestos?>"  data-valor="<?php echo $v->nombrePuesto?>" data-parametro="<?php echo $v->nombreEmpresas?>" data-estatus="<?php echo $v->estatusPuesto?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-floppy-remove"></i></a>
                                           ...
                                           <center>
                                             ...
                                             <a data-toggle="modal" href="#ModalEdita"   data-id="<?php echo $v->idPuestos?>" data-valor="<?php echo $v->nombrePuesto?>"  data-parametro="<?php echo $v->idEmpresas?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-pencil"></i></a>
 ...
 <form class="form-horizontal" id="formitem" action="<?php echo HOME_URL; ?>Administrador/Catalogos"  />
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	...
																	<input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class=" form-control"  name="CatValor" id="CatValor"/>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal"
																aria-hidden="true">&times;</button>
															<h4 class="modal-title">ACTIVAR/DESACTIVAR PUESTO</h4>
														</div>
														<div class="modal-body">
 <form class="form-horizontal" id="formitemElimina" action="<?php echo HOME_URL; ?>Administrador/Catalogos/"  />
															...
															<div class="form-group">
																...
																<div class="col-sm-6">
																	 ...
																	 <input type="text" class=" form-control"  readonly name="Bajaempresa" id="Bajaempresa"/>	
	...
	<script src="<?php echo HOME_URL; ?>assets/js/jquery.fileupload.js"></script>
                                    ...
                                    $('#agregarProducto').click(function(event) {
                                        ...
                                        if ($('#formitem').valid()) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/AddPuestos',
                                                type: 'POST',
                                                dataType: 'json',
					 ...
					 <script type="text/javascript">
                                    ...
                                    $('#eliminarProducto').click(function(event) {
                                        event.preventDefault();
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/EstatusCatalogoPuestos',
                                                type: 'POST',
                                                dataType: 'json',
                                    ...
                                    $('#editarProducto').click(function(event) {
                                        ...
                                        if ($('#formitemEditar').valid()) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/ActualizaCatalogoPuestos',
                                                type: 'POST',
                                                dataType: 'json',
