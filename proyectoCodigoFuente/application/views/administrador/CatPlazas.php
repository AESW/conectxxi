				       ...
				       <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered datatables" id="example">
                                ...
                                <tbody>
                                 ...
                                 <?php 
                                    ...
                                    <tr class="odd gradeX">
                                        <td><?php echo $v->idPlazas?></td>
                                        <td><?php echo $v->nombrePlaza?></td>
                                               <td class="center">
                                           <center>
                                     
                                             <a data-toggle="modal" href="#ModalBaja" data-id="<?php echo $v->idPlazas?>"  data-valor="<?php echo $v->nombrePlaza?>" data-estatus="<?php echo $v->estatus?>" class="btn btn-success open-Modal"><i class="glyphicon glyphicon-floppy-remove"></i></a>
                                           ...
                                           <center>
                                             ...
                                             <a data-toggle="modal" href="#ModalEdita"   data-id="<?php echo $v->idPlazas?>" data-valor="<?php echo $v->nombrePlaza?>"  class="btn btn-success open-Modal"><i class="glyphicon glyphicon-pencil"></i></a>
												...
												<div class="modal-dialog">
													<div class="modal-content">
														<div class="modal-header">
															<button type="button" class="close" data-dismiss="modal"
																aria-hidden="true">&times;</button>
															<h4 class="modal-title">ACTIVAR/DESACTIVAR PLAZA</h4>
														</div>
														<div class="modal-body">
...
<br>
                                    ...
                                    $('#agregarProducto').click(function(event) {
                                        ...
                                        if ($('#formitem').valid()) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/AddPlaza',
                                                type: 'POST',
                                                dataType: 'json',
					 ...
					 <script type="text/javascript">
                                    ...
                                    $('#eliminarProducto').click(function(event) {
                                        event.preventDefault();
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/EstatusCatalogoPlaza',
                                                type: 'POST',
                                                dataType: 'json',
                                    ...
                                    $('#editarProducto').click(function(event) {
                                        ...
                                        if ($('#formitemEditar').valid()) {
                                            ...
                                            $.ajax({
                                                url: '<?php echo HOME_URL; ?>Administrador/ActualizaCatalogoPlaza',
                                                type: 'POST',
                                                dataType: 'json',
