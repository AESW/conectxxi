<div class="content_generic">
    ...
    <div style="width: 99%" class="block_box_descuentos">
        ...
        <h2><label>Importar Bonos</label></h2>
<ul>
        <br>
       	<form   id="basicwizard" name="form1" class="form-horizontal" method="POST" action="<?php echo HOME_URL; ?>Nomina/guardarexcelAbonos" enctype="multipart/form-data" >
