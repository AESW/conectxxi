...
<div class="content_generic">
    ...
    <div style="width: 99%" class="block_box_gen">
        ...
        <h2><label>Aclaraci&oacute;n de Movimientos por empleado</label></h2>
        <p></p>
        <br>
        ...
        <table cellpadding="50" cellspacing="0" width="100%" style="border-collapse: separate; border-spacing: 10px 5px;">
            ...
            <tr>
                <td>Fonacot</td>
                <td ><input type="text" name="fonacot" class="fonacot" id="fonacot"style="border:1px solid blue; height: 15px"></td>  
            </tr>

            <tr>
                <td colspan="3"> <a class="btnNextFDP" id="actualizar">Actualizar</a></td>              
            </tr>
