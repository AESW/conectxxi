<div class="content_generic">
 ...
 <ul>
        <br>
       	<form   id="basicwizard" name="form1" class="form-horizontal" method="POST" action="<?php echo HOME_URL; ?>Nomina/importcsv" enctype="multipart/form-data" >
...
$("#btnBuscar").click(function(){
    		...
    		{	
    			...
    			$.post("<?php echo HOME_URL; ?>Nomina/BuscarDescuento", {
