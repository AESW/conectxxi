...
<div class="content_generic">
    ...
    <div style="width: 99%" class="block_box_gen">
        ...
        <table cellpadding="50" cellspacing="0" width="100%" style="border-collapse: separate; border-spacing: 10px 5px;">
            ...
            <tr>
                <td colspan="3"><label style="margin-left:46%">Inicio descuento</label>
                    <label style="margin-left:8%">Fin descuento</label></td>
            </tr>

            <tr>
                <td colspan="3"><input type="text" onfocus="this.blur()" name="fonacot" class="fonacot" id="fonacot" value="Fonacot" style="border:1px solid blue; height: 20px; width: 200px">
                    <input type="text" name="cant" class="cant" id="cant" style="border:1px solid blue; height: 15px; margin-left:6%; width: 150px">
                    <input type="text" name="iniDscto" class="iniDscto" id="iniDscto" style="border:1px solid blue; height: 15px; margin-left:2%; width: 150px">
                    <input type="text" name="finDscto" class="finDscto" id="finDscto" style="border:1px solid blue; height: 15px; margin-left:2%;  width: 150px">
                    <a class="btnNextFDP" id="agregarMov" href="agregarMov">Agregar movimiento</a></td>   
            </tr>

            <tr>
                <td colspan="3"> <label style="margin-left:45%; margin-top: 15px">Comentarios</label></td>
            </tr>

            <tr>
                <td colspan="3"> <textarea style="width: 100%" name="comentarios"  rows="10" cols="30"></textarea></td>
            </tr>
